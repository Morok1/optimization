...
%JAVABIN%\java -Xbootclasspath:%TESTROOT%;c:\java\jdk1.2\jre\lib\rt.jar;c:\java\jdk1.2\jre\lib\i18n.jar -cp %TESTROOT% "-Djava.security.policy=%TESTROOT%\tuning\distrib\rmi\policy" tuning.distrib.rmi.ClientMain 400 10
pause
