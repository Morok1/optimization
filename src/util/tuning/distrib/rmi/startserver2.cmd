...
pause
start %JAVABIN%\java -cp %TESTROOT% "-Djava.rmi.server.logCalls=false" -Djava.security.policy=%TESTROOT%\tuning\distrib\rmi\policy tuning.distrib.rmi.ServerObjectImpl x
